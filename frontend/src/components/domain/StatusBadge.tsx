...
const STATUS_MAP: Record<string, { label: string; className: string; dot: string }> = {
  ...
  unit_rate:       { label: "واحد بها",       className: "text-primary bg-primary/10 ring-primary/20",                         dot: "bg-primary" },
  cost_plus:       { label: "هزینه + سود",    className: "text-primary bg-primary/10 ring-primary/20",                         dot: "bg-primary" },
