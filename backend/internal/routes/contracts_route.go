...
func SetupContractorRoutes(router fiber.Router, contractorHandler *handlers.ContractHandler) {
	//! Contract and Project Registration Routes
	router.Post("/contractors/new-project", middlewares.AuthMiddleware(), contractorHandler.CreateProject)
